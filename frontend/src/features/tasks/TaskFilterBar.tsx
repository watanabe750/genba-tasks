  ...
  return (
    <section className="mb-4" data-testid="filter-bar">
      ...
      <div className="mb-2 flex items-center justify-between gap-2">
        ...
        <button
          type="button"
          className="text-xs text-gray-600 underline decoration-dotted shrink-0"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
          ...
          <div className="sm:col-span-3 flex justify-start min-w-0">
            <div
              ...
              className="inline-flex rounded-full bg-gray-100 p-1 flex-nowrap whitespace-nowrap"
            >
              {allStatuses.map((s) => {
          ...
          <div className="sm:col-span-1 flex justify-start">
            <select
              ...
              className="w-full max-w-[9rem] rounded border px-2 py-1 text-sm"
              value={order_by}
          ...
          <div className="sm:col-span-1 flex justify-start">
            <select
              data-testid="dir"
              className="w-full max-w-[7rem] rounded border px-2 py-1 text-sm"
              value={dir}
